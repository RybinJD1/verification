...
public class AdminController {
    ...
    public ResponseEntity<Answer> updateAnswer(@PathVariable("id") int id, @RequestBody Answer answer) {
        ...
        answerService.save(currentAnswer);       //может понадобится update метод чтоб id оставался
    ...
    public ResponseEntity<Answer> deleteAnswer(@PathVariable("id") int id) {
        ...
        //проверка на наличие правильный ответ или нет ....
    ...
    @RequestMapping(value = "/question/{id}", method = RequestMethod.GET)//, produces = {MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_XML_VALUE})
